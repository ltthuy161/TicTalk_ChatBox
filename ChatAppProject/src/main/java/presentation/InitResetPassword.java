...
public class InitResetPassword extends javax.swing.JFrame {
     ...
     */
    public InitResetPassword(User user) {
        this.user = user;
        this.userBUS = new UserBUS();
        initComponents();
        this.jTextField2.setText(user.getEmail()); // Pre-fill the email field
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Temporary password");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        String enteredTempPassword = new String(jPasswordField1.getPassword());
        String newPassword = new String(jPasswordField2.getPassword());

        // Basic validation (add more robust validation as needed)
        if (enteredTempPassword.isEmpty() || newPassword.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please fill in all fields.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (!enteredTempPassword.equals(user.getPassword())) {
            JOptionPane.showMessageDialog(this, "Incorrect temporary password.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Update the user's password in the database (using UserBUS)
        boolean updated = userBUS.updateUserPassword(user.getUsername(), newPassword);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // You'll need to pass a User object when creating the form
                // For example:
                User user = new User();
                user.setEmail("test@example.com");
                user.setPassword("tempPassword123");
                new InitResetPassword(user).setVisible(true);
            }
        });
    }
