...
public class Signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel12.setPreferredSize(new java.awt.Dimension(300, 45));
        ...
        jPanel12.add(jLabel11, java.awt.BorderLayout.PAGE_START);
        ...
        jPanel6.add(jLabel10, java.awt.BorderLayout.PAGE_START);
    ...
    private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (username.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Username cannot be empty.", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // Validate inputs
        if (email.isEmpty() || username.isEmpty() || fullname.isEmpty() || dob.isEmpty() || address.isEmpty()) {
        ...
        try {
            ...
            newUser.setDateOfBirth(java.sql.Date.valueOf(dob)); // Ensure the date is in `yyyy-mm-dd` format
            newUser.setAddress(address);
            newUser.setGender(gender);
            newUser.setEmail(email);

            // Use UserBUS to save the new user
            UserBUS userBus = new UserBUS();
            boolean isSaved = userBus.addUser(newUser);

            if (isSaved) {
                JOptionPane.showMessageDialog(this, "Sign up successful! Your temporary password has been sent to your email.", "Success", JOptionPane.INFORMATION_MESSAGE);
                clearForm();

                // Get the newly created user
                User createdUser = userBus.getUserByEmail(email);

                // Open the InitResetPassword form and pass the newly created User object
                if (createdUser != null) {
                    new InitResetPassword(createdUser).setVisible(true);
                } else {
                    // Handle case where user is not found (shouldn't normally happen)
                    JOptionPane.showMessageDialog(this, "Error: User not found after signup.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
    ...
    private void jTextField3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (dateofbirth.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Date of birth cannot be empty.", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void jTextField4ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String fullname = jTextField4.getText();
        if (fullname.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Fullname cannot be empty.", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void jTextField6ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String email = jTextField6.getText();
        if (email.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Email cannot be empty.", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
